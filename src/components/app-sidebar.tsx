...
export function AppSidebar() {
  ...
  return <aside className="fixed bottom-6 left-1/2 z-40 hidden -translate-x-1/2 items-center gap-3 rounded-2xl border border-white/10 bg-zinc-950/70 p-2 shadow-2xl shadow-emerald-950/20 backdrop-blur-2xl md:flex" aria-label="Primary navigation">
